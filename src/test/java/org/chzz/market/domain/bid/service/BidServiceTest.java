...
class BidServiceTest {
    ...
    void setUp() {
        ...
        product = Product.builder().user(user).name("제품1").category(Category.FASHION_AND_CLOTHING).build();
        product2 = Product.builder().user(user).name("제품2").category(Category.FASHION_AND_CLOTHING).build();
        product3 = Product.builder().user(user).name("제품3").category(Category.FASHION_AND_CLOTHING).build();
